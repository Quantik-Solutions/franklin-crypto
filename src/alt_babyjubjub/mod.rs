...
pub use super::jubjub::{
  edwards, montgomery, FixedGenerators, JubjubEngine, JubjubParams, PrimeOrder, ToUniform, Unknown,
};
...
impl AltJubjubBn256 {
  pub fn new() -> Self {
    ...
    // Create the bases for other parts of the protocol
    {
      ...
      fixed_base_generators[FixedGenerators::NoteCommitmentRandomness as usize] = find_group_hash(
        b"r",
        constants::PEDERSEN_HASH_GENERATORS_PERSONALIZATION,
        &tmp_params,
      );
      ...
      fixed_base_generators[FixedGenerators::ValueCommitmentRandomness as usize] = find_group_hash(
        b"r",
        constants::VALUE_COMMITMENT_GENERATOR_PERSONALIZATION,
        &tmp_params,
      );
  ...
  pub fn new_with_hasher<H: GroupHasher>() -> Self {
    ...
    // Create the bases for other parts of the protocol
    {
      ...
      fixed_base_generators[FixedGenerators::ProofGenerationKey as usize] = find_group_hash::<_, H>(
        &[],
        constants::PROOF_GENERATION_KEY_BASE_GENERATOR_PERSONALIZATION,
        &tmp_params,
      );
      ...
      fixed_base_generators[FixedGenerators::NullifierPosition as usize] = find_group_hash::<_, H>(
        &[],
        constants::NULLIFIER_POSITION_IN_TREE_GENERATOR_PERSONALIZATION,
        &tmp_params,
      );

      fixed_base_generators[FixedGenerators::ValueCommitmentValue as usize] = find_group_hash::<_, H>(
        b"v",
        constants::VALUE_COMMITMENT_GENERATOR_PERSONALIZATION,
        &tmp_params,
      );
      ...
      fixed_base_generators[FixedGenerators::SpendingKeyGenerator as usize] = find_group_hash::<_, H>(
        &[],
        constants::SPENDING_KEY_GENERATOR_PERSONALIZATION,
        &tmp_params,
      );
